...
public class Forecast4 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set activity layout
        setContentView(R.layout.activity_forecast4);
        ...
        home.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Forecast4.this, Home.class));
                finish();
        ...
        fore.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Forecast4.this, Fore.class));
                finish();
        ...
        hot.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Forecast4.this, Hot.class));
                finish();
